...
<div ref={card1Ref} className={`animate-fade-up ${card1Visible ? 'visible' : ''}`}>
  <div className={card_style}>
    <p className={card_text}> Billions worth of usable medicines are discarded globally every year.</p>
  </div>
</div>
...
<div ref={card3Ref} className={`animate-fade-up ${card3Visible ? 'visible' : ''}`}>
  <div className={card_style}>
    <p className={card_text}><span className={card_value}>8 – 10%</span> of total healthcare waste is pharmaceutical waste, a growing environmental threat.</p>
  </div>
</div>
<div ref={card4Ref} className={`animate-fade-up ${card4Visible ? 'visible' : ''}`}>
  <div className={card_style}>
    <p className={card_text}>Hospitals and pharmacies discard an estimated <span className={card_value}>₦15 – 20 billion</span> worth of expired drugs annually.</p>
  </div>
</div>
<div ref={card5Ref} className={`animate-fade-up ${card5Visible ? 'visible' : ''}`}>
  <div className={card_style}>
    <p className={card_text}>Over <span className={card_value}>N1 trillion</span> worth of expired/substandard drugs seized in Q1 2025.</p>
  </div>
</div>
